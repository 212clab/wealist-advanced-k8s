...
kubectl rollout restart deployment chat-service noti-service video-service -n wealist-local

# 모든 이미지를 kind 클러스터에 직접 로드

kind load docker-image 212clab/wealist-auth-service:v1 --name wealist
kind load docker-image 212clab/wealist-user-service:v1 --name wealist
kind load docker-image 212clab/wealist-board-service:v1 --name wealist
kind load docker-image 212clab/wealist-chat-service:v1 --name wealist
kind load docker-image 212clab/wealist-noti-service:v1 --name wealist
kind load docker-image 212clab/wealist-storage-service:v1 --name wealist
kind load docker-image 212clab/wealist-video-service:v1 --name wealist
kind load docker-image 212clab/wealist-frontend:v1 --name wealist

# 모든 deployment 재시작

kubectl rollout restart deployment -n wealist-local
